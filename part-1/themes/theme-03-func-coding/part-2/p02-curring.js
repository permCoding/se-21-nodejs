...
const ex_04 = () => { // curring - частичное применение функции
    ...
    let cur = get(20); // возвращает функцию с частичным применением по h
    console.log(cur(100, 50)); // дальше используются упрощенные функции
    console.log(cur(100, 100)); // без h, только w и l
